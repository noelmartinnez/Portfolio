  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        {/* Logo que al darle click te manda al inicio de la página */}
        <Link
          to="/"
        ...
        <ul className="list-none hidden sm:flex flex-row gap-10">
          ...
          {/* Botón que abre una ventana con mi curriculum en Drive */}
          <li className="hover:text-white font-medium cursor-pointer">
            <button
              ...
              onClick={() =>
                abrirEnlace(
                  "https://drive.google.com/file/d/1yjm4yC62on8FiYuYOTTbbtahCDfaQ8Yg/view?usp=share_link"
                )
              }
            >
              Curriculum
